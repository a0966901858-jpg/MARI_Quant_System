...
% 升級：Phase 15.5 Stage 2.5 方案 (★ 5 日連續橫截面超額報酬 Z-Score 目標、
%       LSBoost 連續迴歸選股、OOF 橫截面 Rank IC 監控、截面百分位排序分數輸出、
%       10 日累積崩盤護欄與 Platt 事後機率校準)
% 職責：訓練雙軌選股 GBDT 與崩盤護欄，輸出全域無洩漏 OOF/OOS 專家排序得分與崩盤機率矩陣
% =========================================================================
clear; clc; close all;

disp('=================================================================');
disp('🚀 [Phase 15.5] 啟動 GBDT 連續迴歸選股預測流與 SHAP 歸因分析管線');
disp('=================================================================');
...
% 執行 LSBoost 連續迴歸訓練與折外 Rank IC 監控 (輸出為橫截面百分位排序得分 (0, 1])
...
% 訓練崩盤護欄與 Platt Scaling 事後校準 (維持分類與機率校準架構)
...
disp('=================================================================');
disp('🎯 [Phase 3] 連續迴歸選股流執行完成！請進行下一步回測。');
disp('=================================================================');