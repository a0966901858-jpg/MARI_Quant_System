...
% 升級：Phase 15.5 Stage 0/1/2 統一規範版 (★ 防禦 NaN 傳導、支援 Soft-IC 損失)
...
% ★ 已移除未使用的 AdjMatrix_3D，消除 Linter 警告並加速 I/O
...
% ★ 將 std 確保轉為欄向量，再水平拼接為 [18, 2]
b3 = bar([std_raw(:), std_gics(:)], 'grouped');
b3(1).FaceColor = [0.0000, 0.4470, 0.7410]; % Raw 顏色
b3(2).FaceColor = [0.8500, 0.3250, 0.0980]; % GICS 顏色
...
%% =====================================================================
% 輔助函數：逐日損失與線性探針 (AUC 或 Rank IC) 評估
% =====================================================================
